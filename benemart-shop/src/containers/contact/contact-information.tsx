...
const data = [
  {
    ...
    description: '111 edgahpara mir mossarof Lane, kushtia sadar, kushtia, Bangladesh',
  },
  {
    id: 2,
    slug: '/',
    ...
    description: 'Change the design through a range +8801303525827',
  },
  {
    id: 3,
    slug: '/',
    ...
    name: 'Send Email',
    description: 'support@devalamin.com hire.devalamin@gmail.com',
  },
];
